...
import { StudentFilesPage } from './StudentFilesPage.jsx'
import { StudentExplainPage } from './StudentExplainPage.jsx'
import StudentPaymentsPage from './StudentPaymentsPage.jsx'
import StudentNotificationsPage from './StudentNotificationsPage.jsx'
import { loadNotifications, markNotificationRead, subscribeNotifications } from '../../student/studentNotificationsData.js'
...
const navItems = [['Dashboard', '/student/dashboard', Home], ['My Tasks', '/student/tasks', ClipboardList], ['Messages', '/student/messages', MessageCircle], ['Files & Deliveries', '/student/files', FolderOpen], ['Explain & Defend', '/student/explain', BookOpen], ['Payments', '/student/payments', CreditCard]]
  ...
  return <section className="student-now-canvas" aria-label="Now Canvas">
    <div className="student-now-grid">
      ...
      <div className="student-now-right">
        ...
        {isDelivery && <ActionButton onClick={() => go('/student/files')}>Review Delivery <ArrowRight size={15} /></ActionButton>}
...
export function StudentDashboard() {
  ...
  useEffect(() => {
    if (!notificationsOpen) loadNotifications({ force: true }).catch(() => {})
  }, [notificationsOpen])
